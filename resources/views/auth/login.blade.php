                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="font-weight-bolder text-success text-gradient">Log-in</h3>
                        ...
                        <div class="card-body">
                            <form role="form">
                                ...
                                <div class="mb-3">
                                    <input type="email" class="form-control" placeholder="Password" aria-label="Password" name="password"
                               ...
                               {{--  <div class="form-check form-switch">
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn bg-gradient-success w-100 mt-4 mb-0">Sign
                                        in</button>
                                </div>
                            </form>
                        </div>
