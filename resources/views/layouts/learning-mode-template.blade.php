    ...
    <div id="loading">
        <div class="loader ">
            <div class="loader-body word-spacing">
                <h1 class="loader-title fw-bold">BMA STUDENT LMS</h1>
            </div>
        </div>
    </div>
    <!-- loader END -->
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar py-lg-0">
            <div class="container-fluid navbar-inner">
                ...
                <a class="navbar-brand">
                    <h2 class="logo-title ">{{ $_subject_class->curriculum_subject->subject->subject_code }}</h2>
                </a>
                <div>
                    <p class="text-primary mt-2 mb-0">
                        {{ $_subject_class->curriculum_subject->subject->subject_name }}</p>
                    <small>{{ strtoupper($_subject_class->staff->first_name . ' ' . $_subject_class->staff->last_name) }}</small>
