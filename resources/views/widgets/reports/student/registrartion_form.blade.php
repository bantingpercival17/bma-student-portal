                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="40%" class="text-fill-in">
                                <b> {{ Auth::user()->course->course_name }}</b>
                            </td>
                            <td width="3%"><small>YEAR:</small></td>
                            <td class="text-fill-in">
                                <b>{{ Auth::user()->course_id == 3? 'GRADE ' . Auth::user()->year_level: Auth::user()->year_level . ' CLASS' }}</b>
                            </td>
                            <td width="5%"><small>SEMESTER:</small></td>
                            <td class="text-fill-in">
                                <b> {{ strtoupper(Auth::user()->academic->semester) }}</b>
                            </td>

                            <td width="3%"><small>AY:</small></td>
                            <td class="text-fill-in">
                                <b> {{ Auth::user()->academic->school_year }}</b>
                            </td>
                ...
                <table class="form-rg-table">
                    <tbody>
                        <tr class="text-center">
                            ...
                            <td colspan="2">
                                <u><b>{{ strtoupper(date('F j, Y', strtotime($_student->created_at))) }}</b></u>
                            </td>
                        </tr>
                        <tr class="text-center">
