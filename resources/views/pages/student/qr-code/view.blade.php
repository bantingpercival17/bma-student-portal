...
@section('page-content')
    <div class="card">
        <div class="card-body">
            <form id="form-wizard1" class="text-center mt-3" action="/student/attendance" method="POST">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span
                                        class="form-control full-name">{{ Auth::user()->student->first_name . ' ' . Auth::user()->student->last_name }}</span>
                                    <input type="hidden" name="employee" class="employee"
                                        value="{{ Auth::user()->campus_email }}">
                                    @error('employee')
