...
@if (Auth::user()->student->enrollment_application)
    ...
    @section('step-2-dot-active')
            ...
            <div class="d-inline-block w-100">
                ...
                <div class="mt-1 mb-3 row">
                    ...
                    <p class="text-info h5 fw-bolder">
                        {{ Auth::user()->student->enrollment_application->course->course_name }}</p> --}}
                    </div>
                    <div class="col-md">
                        {{-- <label for="" class="fw-bolder text-muted"></label>
                    {{Auth::user()->student->enrollment_assessment->}} --}}
                    </div>
                </div>
        ...
        @endif
    @endsection
    @if (Auth::user()->student->enrollment_application->is_approved)
            ...
            <div class="d-inline-block w-100">
                ...
                <div class="row mt-2">
                    <div class="col-md">
                        <label for="" class="fw-bolder text-muted">COURSE</label>
                        <p class="text-info h5 fw-bolder">
                            {{ Auth::user()->student->current_enrollment->course->course_name }}</p>
                    </div>
                    <div class="col-md">
                        <label for="" class="fw-bolder text-muted">YEAR LEVEL</label>
                        <p class="text-info h5 fw-bolder">
                            @if (Auth::user()->student->current_enrollment->course_id == 3)
                                GRADE {{ Auth::user()->student->current_enrollment->year_level }}
                            @else
                                {{ Auth::user()->student->current_enrollment->year_level }} CLASS
                            @endif
