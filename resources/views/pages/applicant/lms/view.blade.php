    ...
    <div class="row">
        @if (count($_subject_class) > 0)
            @foreach ($_subject_class as $subject)
                <div class=" col-sm-12 col-md-6">
                    <a href="{{ route('lms.subject-class') }}?_subject={{ base64_encode($subject->id) }}">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="image">
                                            <img src="{{ $_image }}"
                                                class="img-fluid avatar avatar-100 avatar-rounded " alt="User Image"
                                                width="100px">
                                        </div>
                                    </div>
                                </div>
        ...
        @else
            <div class="col-md-12 text-center">
                ...
                <label for="" class="h1 text-primary"> <b>Please stand by for your Batch Schedule</b></label>
            </div>
        @endif
    </div>
@endsection
