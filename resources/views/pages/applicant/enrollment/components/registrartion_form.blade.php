...
@section('page-content')
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mx-3 my-3">
            <div class="d-flex flex-wrap align-items-center">
                <div class="profile-img position-relative me-3 mb-3 mb-lg-0">
                    @if (Auth::user()->image)
                        <img src="{{ json_decode(Auth::user()->image->file_links)[0] }}"
                            class="img-fluid avatar avatar-90 rounded-circle" alt="applicant-profile">
                    @else
                    @endif
                    {{-- <img src="{{ asset(Auth::user()->applicant->profile_pic(Auth::user())) }}" alt="User-Profile"
                        class="img-fluid avatar avatar-90 rounded-circle"> --}}
                </div>
                <div class="d-flex align-items-center mb-3 mb-sm-0">
                    <div>
                        <h4 class="me-2 text-primary">
                            {{ Auth::user()->applicant->last_name . ', ' . Auth::user()->applicant->first_name }}</h4>
                        <span><svg width="19" height="19" class="me-2" viewBox="0 0 24 24" fill="none"
                                ...
                                class="mb-0 text-dark">{{ ucwords(Auth::user()->applicant->municipality . ', ' . Auth::user()->applicant->province) }}</small></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('applicant.registration-form-store') }}" method="post">
                    @csrf
                    ...
                    <div class="form-view">
                        ...
                        <div class="row">
                            <div class="col-xl col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control "
                                        value="{{ old('_last_name') ?: ucwords(Auth::user()->applicant->last_name) }}"
                                        name="_last_name">
                                    @error('_last_name')
                            ...
                            <div class="col-xl col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                        value="{{ old('_first_name') ?: ucwords(Auth::user()->applicant->first_name) }}"
                                        name="_first_name">
                                    @error('_first_name')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                            ...
                            <div class="col-xl col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                        value="{{ old('_middle_name') ?: ucwords(Auth::user()->applicant->middle_name) }}"
                                        name="_middle_name">
                            ...
                            <div class="col-xl-2 col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-extension" name="_extension_name"
                                        value="{{ (old('_extension') ?: Auth::user()->applicant->extention_name) ? ucwords(Auth::user()->applicant->extention_name) : '' }}">
                                    <div class="form-check">
                        ...
                        <div class="row">
                            <div class="col-xl-2 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text"
                                        value="{{ ucwords(Auth::user()->applicant->sex) }}" name="_gender">
                                    @error('_gender')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date"
                                        value="{{ old('_birthday') ?: Auth::user()->applicant->birthday }}"
                                        name="_birthday">
                                    @error('_birthday')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text"
                                        value="{{ old('_birth_place') ?: ucwords(Auth::user()->applicant->birth_place) }}"
                                        name="_birth_place">
                                    @error('_birth_place')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_civil_status"
                                        value="{{ old('_civil_status') ?: ucwords(Auth::user()->applicant->civil_status) }}">
                                    @error('_civil_status')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_nationality"
                                        value="{{ old('_nationality') ?: Auth::user()->applicant->nationality }}">
                                    @error('_nationality')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_religion"
                                        value="{{ old('_religion') ?: Auth::user()->applicant->religion }}">
                                    @error('_religion')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-5 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_street"
                                        value="{{ old('_street') ?: ucwords(Auth::user()->applicant->street) }}">
                                    @error('_street')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_barangay"
                                        value="{{ old('_barangay') ?: ucwords(Auth::user()->applicant->barangay) }}">
                                    @error('_barangay')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_zip_code"
                                        value="{{ old('_zip_code') ?: ucwords(Auth::user()->applicant->zip_code) }}">
                                    @error('_zip_code')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="_municipality"
                                        value="{{ old('_municipality') ?: ucwords(Auth::user()->applicant->municipality) }}"
                                        class="form-control">
                                    @error('_municipality')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_province"
                                        value="{{ old('_province') ?: ucwords(Auth::user()->applicant->province) }}">
                                    @error('_province')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_contact_number"
                                        value="{{ old('_contact_number') ?: Auth::user()->contact_number ?: '' }}">
                            ...
                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="_personal_email"
                                        value="{{ old('_personal_email') ?: Auth::user()->email ?: '' }}">
                                    ...
                                    <div class="col-xl col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"
                                                ...
                                                value="{{ old(str_replace(' ', '_', strtolower($item)) . '_name') ?: Auth::user()->applicant[str_replace(' ', '_', strtolower($item)) . '_name'] }}">
                                    ...
                                    <div class="col-xl col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"
                                                ...
                                                value="{{ old(str_replace(' ', '_', strtolower($item)) . '_address') ?: Auth::user()->applicant[str_replace(' ', '_', strtolower($item)) . '_address'] }}">
                                    ...
                                    <div class="col-xl col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="month"
                                                ...
                                                value="{{ old(str_replace(' ', '_', strtolower($item)) . '_year') ?: Auth::user()->applicant[str_replace(' ', '_', strtolower($item)) . '_year'] }}">
                        ...
                        @php
                            $_parent_details = Auth::user()->applicant;
