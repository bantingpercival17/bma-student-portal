                            ...
                            <div class="col-md">
                                @if (Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction)
                                    ...
                                    <div class="align-items-center">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <p class="fw-bolder">
                                                    {{ Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->created_at->format('d, F Y') }}
                                                </p>
                                            </div>
                                            <div class="col-md">
                                                <small class="form-label">
                                                ...
                                                <p class="fw-bolder text-primary h5">
                                                    {{ Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->reference_number }}
                                                </p>
                                            </div>
                                            <div class="col-md">
                                                <small class="form-label">
                                                ...
                                                <p class="fw-bolder text-primary h5">
                                                    PHP
                                                    {{ number_format(Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->amount_paid) }}
                                                </p>
                                            </div>
                                            <div class="col-md-12">
                                                <small class="form-label">
                                                ...
                                                <a href="{{ Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->reciept_attach_path }}"
                                                    target="_blank"
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            @if (Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->is_approved === null)
                                                <div>
                                            ...
                                            @endif
                                            @if (Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->is_approved === 0)
                                                <div>
                                                    <span class="text-info">This payment was
                                                        disapproved because of this Remarks: </span>
                                                    <span
                                                        class="text-danger">{{ Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->comment_remarks }}</span>
                                                </div>
                                            @endif
                                    ...
                                    @if (Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->online_transaction->is_approved === 0)
                                        ...
                                        <form action="{{ route('applicant.enrollment-online-transaction-payment') }}"
                                            method="post" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="_assessment"
                                                value="{{ base64_encode(Auth::user()->enrollment_registration()->enrollment_assessment->payment_assessments->id) }}">
