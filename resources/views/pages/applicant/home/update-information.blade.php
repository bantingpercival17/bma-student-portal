...
@section('page-content')
        ...
        <div class="card">
            <div class="card-header pb-0 p-3">
                <div class="header-title">
                    <div class="row">
                        <div class="col-md">
                            <h5 class="mb-1"><b>UPDATE PROFILE INFORMATION</b></h5>
            ...
            <div class="card-body">
                <form action="{{ route('applicant.store-detials') }}" method="post">
                    ...
                    <div class="form-view">
                        ...
                        <div class="row">
                            <div class="col-xl col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control " value="{{ old('last_name') ?: $_applicant->last_name }}"
                                        name="last_name">
                                    @error('last_name')
                            ...
                            <div class="col-xl col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                        value="{{ old('first_name') ?: $_applicant->first_name }}" name="first_name">
                                    @error('first_name')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                        value="{{ old('middle_name') ?: $_applicant->middle_name }}" name="middle_name">
                            ...
                            <div class="col-xl-2 col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-extension" name="extention_name"
                                        value="{{ old('extension') ?: $_applicant->extention_name }}">
                                    <div class="form-check">
                        ...
                        {{--  --}}
                        <div class="row">
                            <div class="col-xl-2 col-md mb-xl-0">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Gender</label>
                                    <select name="sex" id="" class="form-select">
                                        <option value="Male"
                                            value="{{ old('sex') == 'Male' ? 'selected' : ($_applicant->sex = 'Male' ? 'selected' : '') }}">
                                            Male
                                        </option>
                                        <option value="Female"
                                            value="{{ old('sex') == 'Female' ? 'selected' : ($_applicant->sex = 'Female' ? 'selected' : '') }}">
                                            Female
                                        </option>
                                    </select>
                            ...
                            <div class="col-xl-4 col-md-4 mb-xl-0">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Birthday</label>
                                    <input class="form-control" type="date"
                                        value="{{ old('birthday') ?: $_applicant->birthday }}" name="birthday">
                                    @error('birthday')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            </div>
                            <div class="col-xl col-md mb-xl-0">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Birth Place</label>
                                    <input class="form-control" type="text"
                                        value="{{ old('birth_place') ?: $_applicant->birth_place }}" name="birth_place">
                                    @error('birth_place')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-5 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="street"
                                        value="{{ old('street') ?: $_applicant->street }}">
                                    @error('street')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="barangay"
                                        value="{{ old('barangay') ?: $_applicant->barangay }}">
                                    @error('barangay')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="zip_code"
                                        value="{{ old('zip_code') ?: $_applicant->zip_code }}">
                                    @error('zip_code')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="municipality"
                                        value="{{ old('municipality') ?: $_applicant->municipality }}"
                                        class="form-control">
                                    @error('municipality')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="province"
                                        value="{{ old('province') ?: $_applicant->province }}">
                                    @error('province')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="civil_status"
                                        value="{{ old('civil_status') ?: $_applicant->civil_status }}">
                                    @error('civil_status')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nationality"
                                        value="{{ old('nationality') ?: $_applicant->nationality }}">
                                    @error('nationality')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl col-md-6 mb-xl-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="religion"
                                        value="{{ old('religion') ?: $_applicant->religion }}">
                                    @error('religion')
                                        <label for="" class="badge bg-danger text-small mt-2">{{ $message }}</label>
                                    @enderror
                                </div>
                                ...
                                <div class="col-xl col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                            ...
                                            value="{{ old(str_replace(' ', '_', strtolower($item)) . '_name') ?:$_applicant[str_replace(' ', '_', strtolower($item)) . '_name'] }}">
                                ...
                                <div class="col-xl col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                            ...
                                            value="{{ old(str_replace(' ', '_', strtolower($item)) . '_address') ?:$_applicant[str_replace(' ', '_', strtolower($item)) . '_address'] }}">
                                ...
                                <div class="col-xl col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="month"
                                            ...
                                            value="{{ old(str_replace(' ', '_', strtolower($item)) . '_year') ?:date_format(date_create($_applicant[str_replace(' ', '_', strtolower($item) . '_year')]), 'Y-m') }}">
    ...
    $_income = ['Below 10,000', '10,000-20,000', '20,000-40,000', '40,000-60,000', '60,000 Above', 'N/A'];
                                    ...
                                    <div class="col-xl-4 col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="{{ $parent }}_last_name"
                                                value="{{ old($parent . '_last_name') ?: $_applicant[$parent . '_last_name'] }}">
                                    ...
                                    <div class="col-xl-4 col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ old($parent . '_first_name') ?: $_applicant[$parent . '_first_name'] }}">
                                    ...
                                    <div class="col-xl-4 col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ old($parent . '_middle_name') ?: $_applicant[$parent . '_middle_name'] }}">
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ old($parent . '_contact_number') ?: $_applicant[$parent . '_contact_number'] }}">
                                            <span>
                                            ...
                                            <select name="{{ $parent }}_educational_attainment"
                                                ...
                                                @foreach ($_educational_attainment as $_select_0)
                                                    <option value="{{ $_select_0 }}"
                                                        {{ old($parent . '_educational_attainment') == $_select_0? 'selected': ($_applicant[$parent . '_educational_attainment'] == $_select_0? 'selected': '') }}>
                                                        {{ $_select_0 }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="{{ $parent }}_employment_status" class="form-select">
                                                ...
                                                @foreach ($_employment_status as $_select_1)
                                                    <option value="{{ $_select_1 }}"
                                                        {{ old($parent . '_employment_status') == $_select_1? 'selected': ($_applicant[$parent . '_employment_status'] == $_select_1? 'selected': '') }}>
                                                        {{ $_select_1 }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <select name="{{ $parent }}_working_arrangement" class="form-select">
                                            ...
                                            @foreach ($_arrangement as $_select_2)
                                                <option value="{{ $_select_2 }}"
                                                    {{ old($parent . '_working_arrangement') == $_select_2? 'selected': ($_applicant[$parent . '_working_arrangement'] == $_select_2? 'selected': '') }}>
                                                    {{ $_select_2 }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <button type="submit" class="btn btn-primary mt-2 w-100">Update Student Information</button>
                    </div>
                </form>
