@php
$_title = 'STEP 1: APPLICANT INFORMATION';
@endphp
...
@section('step-1-dot-done')
    ...
    <div class="row">
        ...
        <div class="col-md">
            ...
            <a href="{{ route('applicant.update-information') }}" class="btn btn-info btn-sm text-white">
                Update Application Form
            </a>
            <a href="{{ route('applicant-form') }}" class="btn btn-primary btn-sm mt-2">View
                Application
                Form</a>
        </div>
    </div>
